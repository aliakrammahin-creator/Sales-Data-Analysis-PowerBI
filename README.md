...
2. Explore the relationship between Profit and Net Sales.
3. Analyse sales trends over time:
   - Daily
   - Monthly
   - Quarterly
   - Yearly
4. Analyse sales performance across different cities.
5. Calculate the total number of customer orders.
6. Identify the Top 5 and Bottom 5 products based on:
   - Sales
   - Profit
   - Quantity Sold
7. Compare Sales, Profit and Quantity Sold between two user-selected periods.
8. Display detailed order-level information including:
   - Sales
   - Profit
   - Discount
   - Discount Percentage
...
- Geographic sales visualisation
- Product performance analysis
- Comparative sales analysis
- Order-level transaction reporting
- Star schema data model

## DAX Measures
Several DAX measures were created to calculate:
- sum of profit
- sum of net sales
- Quantity sold
